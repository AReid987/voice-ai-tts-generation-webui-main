...
*In case of issues, feel free to contact the developers_.
...
#### _Is there any more optimal way to do this?_
...
* Bark: MIT
* Tortoise: _Unknown_ (Apache-2.0 according to repo, but no license file in HuggingFace)
